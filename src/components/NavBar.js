...
import { TwitterIcon, DribbbleIcon, GithubIcon, LinkedInIcon, PinterestIcon, MoonIcon, SunIcon } from './Icons'; // Make sure to import MoonIcon and SunIcon components
  ...
  return (
      ...
      >
          ...
          <div className='w-full flex justify-between items-center lg:hidden'>
              ...
              <CustomLink href="/articles" title="Articles & Certs" className='ml-4' />
          </nav>    
...

          {
           ...
           '>
                    ...
                    <nav className= "flex items-cneter flex-col justify-center">
