      ...
      <div className="flex flex-col md:flex-row md:space-x-6 space-y-6 md:space-y-0 bg-cyan-950 w-full max-w-4xl p-8 sm:p-12 rounded-xl shadow-lg text-white ">
        <div className="flex flex-col space-y-8 justify-between ">
          <div>
            ...
            <p className="pt-2 text-cyan-100 text-sm">If there is a will there is a Way!</p>
          </div>
            ...
            <div className=" bg-white rounded-xl shadow-lg p-8 text-gray-600 md:w-80 flex-grow">
              <form action='' className="flex flex-col space-y-4 ">
                <div>
                  ...
                  <input type="text" placeholder="Your name" className="ring-1 ring-gray-300 w-full rounded-md px-4 py-2 mt-2 
                ...
                <div>
                  ...
                  <textarea type="text" placeholder="Message" rows='4' className="ring-1 ring-gray-300 w-full rounded-md px-4 py-2 mt-2 outline-none
